...
export const addNewTaskAction = async (userID, formData) => {
    ...
    try {
        ...
        // error message
        toast.error('There was an error while creating a new task')
...
export const updateTaskDataAction = async (userID, taskID, formData) => {
    ...
    try {
        ...
        // error message
        toast.error('There was an error while updating the selected task')
...
export const deleteTaskAction = async (userID, taskID) => {
    try {
        ...
        toast.error('There was an error while deleting the selected task')
