        ...
        <section className='new-task-form bg-orange-100 py-5 px-10 w-3/4 mx-auto rounded-xl'>
            <form ref={ref} action={async (formData) => {
                ...
                <div className="grid grid-cols-2 gap-10">
                    ...
                    <div>
                        <textarea className="block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" name="taskContent" id="" rows='7' required />
                    </div>
                </div>
            </form>
        </section>
